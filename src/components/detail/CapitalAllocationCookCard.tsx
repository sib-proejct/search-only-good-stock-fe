      ...
      <div className="flex flex-col sm:flex-row items-center gap-8 py-2">
        ...
        <div className="relative w-36 h-36 flex items-center justify-center shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
            <span className="text-2xl font-bold font-mono text-[#1D1D1F] dark:text-[#F5F5F7] tabular-nums tracking-tight">
              {buybacksPct}%
            </span>
        ...
        <div className="flex-1 space-y-3 text-center sm:text-left">
          <div>
            <div className="text-3xl font-bold font-mono text-[#1D1D1F] dark:text-[#F5F5F7] tracking-tight tabular-nums">
              $650B
            </div>
            <p className="text-xs text-[#86868B] mt-1 font-normal leading-relaxed">
              {t('sharesRetiredSub')}
            </p>
          </div>
          ...
          <div className="space-y-1.5 pt-2 text-xs">
            <div className="flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-[#0071E3] dark:bg-[#2997FF] shrink-0" />
              <span className="text-[#1D1D1F] dark:text-[#F5F5F7] font-medium">{t('shareRepurchases')} ({buybacksPct}%)</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-[#D2D2D7] dark:bg-[#5E5E63] shrink-0" />
