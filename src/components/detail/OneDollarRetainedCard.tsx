      ...
      <div className="space-y-3">
        <div>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl sm:text-3xl lg:text-4xl font-bold font-mono text-[#1D1D1F] dark:text-[#F5F5F7] tracking-tight tabular-nums">
        ...
        <div className="space-y-1.5 pt-0.5">
          ...
          <div className="h-2.5 w-full bg-[#EBEBED] dark:bg-[#2C2C2E] rounded-full overflow-hidden flex">
